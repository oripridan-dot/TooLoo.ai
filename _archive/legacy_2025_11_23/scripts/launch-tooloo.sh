...
echo "   Core: training(3001), meta(3002), budget(3003)"
echo "   AI: coach(3004), product(3006), segmentation(3007)"
echo "   Analytics: reports(3008), capabilities(3009)"
...
echo ""
echo "🔧 Essential Services (unified multi-service platform):"
echo "   Port 3000:  Web Server (API proxy & UI)"
echo "   Port 3001:  Training Engine"
echo "   Port 3002:  Meta-Learning Server"
echo "   Port 3003:  Budget & Resource Manager"
echo "   Port 3004:  Auto-Coach Engine"
echo "   Port 3006:  Product Development Studio"
echo "   Port 3007:  Conversation Segmentation"
echo "   Port 3008:  Analytics & Reports"
echo "   Port 3009:  Capability Manager"
echo ""
echo "📝 Logs:"
