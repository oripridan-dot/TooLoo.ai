...
/**
 * TooLoo.ai VS Code Embedded UI
 * Creates a webview panel that appears above the terminal in VS Code
 */

import fs from 'fs';
import path from 'path';

// Create the embedded UI HTML
const embeddedUI = `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="control-panel">
        ...
        <div class="right-panel">
            <div class="header">💬 TooLoo.ai Chat</div>
    ...
    <script>
        ...
        function takeScreenshot() {
            ...
            msg.innerHTML = '<strong>System:</strong> 📸 Screenshot captured for visual documentation. Screen visibility active.';
        ...
        console.log('🎯 TooLoo.ai embedded UI loaded successfully!');
    </script>
</body>
</html>
`;

// Write the embedded UI file
fs.writeFileSync('tooloo-embedded-ui.html', embeddedUI);

console.log('🎯 EMBEDDED UI CREATED!');
console.log('📄 File: tooloo-embedded-ui.html');
console.log('🎮 To open above terminal:');
console.log('   1. Right-click tooloo-embedded-ui.html');
console.log('   2. Select "Open Preview" or "Open with Live Server"');
console.log('   3. UI will appear in VS Code panel above terminal');
console.log('✅ This gives you TooLoo.ai interface exactly where you want it!');