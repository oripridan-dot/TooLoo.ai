...
import { systemExecute, type SystemInput, type SystemOutput } from './logic.js';
...
}) as z.ZodType<SystemOutput>;

// =============================================================================
// SKILL DEFINITION
// =============================================================================

export const SystemSkill = defineSkill<SystemInput, SystemOutput>({
  id: 'core.system',
  name: 'Settings',
