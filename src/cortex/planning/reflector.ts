...
`;
    ...
    try {
      ...
      const content = (response as any).text || response.content;
  ...
  private async analyzeFailure(step: PlanStep, result: any, plan: Plan): Promise<ReflectionResult> {
...
`;
  ...
  private async analyzeSuccess(step: PlanStep, result: any, plan: Plan): Promise<ReflectionResult> {
