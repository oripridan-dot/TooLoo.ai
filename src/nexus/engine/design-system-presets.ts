...
const DESIGN_SYSTEM_PRESETS = {
  ...
  antDesign: {
    ...
    typography: {
      ...
      secondary:
        '"SFMono", "Monaco", "Cascadia Code", "Roboto Mono", Consolas, "Courier New", monospace',
  ...
  appleHIG: {
    ...
    typography: {
      primary:
        'system-ui, -apple-system, BlinkMacSystemFont, "San Francisco", sans-serif',
  ...
  tailwind: {
    ...
    typography: {
      ...
      secondary:
        'ui-monospace, SFMono-Regular, "SF Mono", Courier New, monospace',
  ...
  bootstrap: {
    ...
    typography: {
      ...
      secondary:
        '"SFMono-Regular", SFMono-Regular, Menlo, "Courier New", monospace',
