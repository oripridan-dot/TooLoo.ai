    ...
    router.post('/invoke', async (req, res, next) => {
        try {
            ...
            const response = {
                ...
                ui: {
                    type: skill.ui.placement === 'hidden' ? 'headless' : 'static',
        ...
        try {
            ...
            res.json({
                ...
                routing: {
                    ...
                    alternatives: routeInfo?.alternatives.map((a) => ({
                        id: a.skill.id,
...
// ERROR HANDLER
// =============================================================================
export function kernelErrorHandler(err, _req, res, _next) {
...
// =============================================================================
export async function startKernelServer(port = 4002) {
